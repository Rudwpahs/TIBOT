...
hi = ['안념하세요 도우미 챗봇 티봇입니다!','티봇입니다! ⌛','왔습니다 🚀 -티봇',\
		'티봇의 도움을 필요하시나요? ']
dobby_say(f"{random.choice(hi)}\n" + "사용자님이 찾으시는 학교명을 입력해주세요!")
...
while not quit:
	...
	clear()
	wait_input = ["무엇을 하실껀가요, 사용자님?", "사용자님, 무엇을 하실껀가요?", "사용자님을 기다리고 있습니다.."]
	...
	if "급식" in msg:
		...
		dobby_say("티봇는 그런건 할 줄 몰라요 \n\"도움말\"을 입력해 티봇에 대해 알아보아요 :)")
